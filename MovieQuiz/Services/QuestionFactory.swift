...
final class QuestionFactory: QuestionFactoryProtocol {
    ...
    func requestNextQuestion() {
        DispatchQueue.global().async { [weak self] in
            ...
            let randomRating = (1...9).randomElement() ?? 5
            let randomBool = [true, false].randomElement() ?? true
            let text = "Рейтинг этого фильма" + (randomBool ? " больше" : " меньше") + " чем \(randomRating)?"
